...
/*!
* \brief ODBG2_Plugininit [OD插件可选导出函数] 
* 插件加载完毕后,OD会调用该函数,以让插件来初始化自身,当插件通过版本检测后准备加载时，OllyDBG会调用此函数.
* 在这个函数中,可以完成创建窗口等初始化工作.
* \sa ODBG2_Pluginquery(),ODBG2_Pluginclose(),ODBG2_Pluginreset(),ODBG2_Plugindestroy()
*/
...
/*!
* \brief ODBG2_Pluginreset [OD插件可选导出函数]
* 当重新加载程序或打开新程序时，OllyDBG会调用此函数
*/
pentry( void )        ODBG2_Pluginreset( void );


/*!
* \brief ODBG2_Pluginclose [OD插件可选导出函数]
* 当用户关闭调试时，OllyDBG在关闭前会调用此函数
*/
...
/*!
* \brief ODBG2_Plugindestroy [OD插件可选导出函数]
* 当OllyDBG将要终止时，它会在退出前调用一次此函数
*/
...
/*!
* \brief ODBG2_Pluginanalyse [OD插件可选导出函数] 
*分析模块时，在分析结束后OllyDBG会调用此函数，给插件以机会使之能做一些额外的分析操作
* \param t_module * pmod 分析完成的模块的信息
*/
...
/*!
* \brief ODBG2_Pluginmainloop [OD可选导出函数]
* 有调试事件时,就会调用此函数
* \param DEBUG_EVENT * debugevent 正在发生的调试事件.
*/
...
/*!
* \brief ODBG2_Pluginexception [OD插件可选导出函数]
* 产生EXCEPTION_DEBUG_EVENT(异常事件)时就调用此函数.
* \param t_run * prun 运行时的一些信息
* \param const t_disasm * da 反汇编信息
* \param t_thread * pthr 产生异常事件的线程的信息
* \param t_reg * preg 寄存器信息
* \param wchar_t * message 
*/
...
/*!
* \brief ODBG2_Plugintempbreakpoint [OD插件可选导出函数]
* 插件请求设置的临时断点事件会调用此函数
* \param ulong addr 断点地址
* \param const t_disasm * da 反汇编信息
* \param t_thread * pthr 线程信息
* \param t_reg * preg 寄存器信息
*/
...
/*!
* \brief ODBG2_Pluginnotify [OD插件可选导出函数]
