...
LRESULT CALLBACK WndProc(HWND hWnd, UINT message, WPARAM wParam, LPARAM lParam)
{
	...
	case WM_COMMAND:
	{
		...
		case IDM_ABOUT:
		{
			...
			//add by yue
			//CreateWindowEx(NULL, szWindowClass, TEXT("yue"), WS_CHILD | WS_VISIBLE | WS_OVERLAPPEDWINDOW | WS_CLIPSIBLINGS, 30, 30, 400, 300, hWnd, NULL, hInst, NULL);
			DWORD dwStyleB = BS_PUSHBUTTON | WS_CHILD | WS_VISIBLE;
			CreateWindow(L"listbox", L"12345", dwStyleB, 60, 100, 60, 20, hWnd, (HMENU)0x1000, hInst, NULL);
		}
		break;
		case IDM_EXIT:
			DestroyWindow(hWnd);
